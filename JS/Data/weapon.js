...
var rangedWeapon20 = new rangedWeapon("B50FG", '远程武器', '加农炮', '.50 AP', 12, 19, true, "A crude prototype meant to bring the power of an anti-aircraft gun down to portable size.<br>If you dream of raw, blistering firepower, this is weapon for you.", "一个粗糙的原型意味着将高射炮的威力降低到一个可移动的尺寸。<br>如果你梦想着一个生猛的武器，就是它了。");
